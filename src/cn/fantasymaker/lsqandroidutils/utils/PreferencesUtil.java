 ...
 * <li>you can change preference name by {@link #PREFERENCE_FILE_NAME}</li>
 * </ul>
 * <ul>
...
public class PreferencesUtil {
	...
	private PreferencesUtil() throws InstantiationException{
		throw new InstantiationException("Instantiation is not allowed! Use static methods only!");
	}

    public static String PREFERENCE_FILE_NAME = "config";
    ...
    public static boolean putString(Context context, String key, String value) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_FILE_NAME, Context.MODE_PRIVATE);
